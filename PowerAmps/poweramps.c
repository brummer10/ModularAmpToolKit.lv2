...
#define PLUGIN_UI_URI "urn:brummer:poweramps_ui"
...
const char* plugin_set_name() {
    return "PowerAmps"; //set plugin name to display on UI
}
...
void plugin_create_controller_widgets(X11_UI *ui, const char * plugin_uri, float scale) {
    ...
    combobox_add_entry (ui->widget[3], "Push Pull EL84");
    combobox_add_entry (ui->widget[3], "Push Pull EL34");
    combobox_add_entry (ui->widget[3], "Push Pull 6L6");
    combobox_add_entry (ui->widget[3], "Single ended 6V6GT");
    combobox_add_entry (ui->widget[3], "Single ended EL84");
    combobox_add_entry (ui->widget[3], "Single ended 6V6");
    set_adjustment(ui->widget[3]->adj, 0.0, 0.0, 0.0, 5.0, 1.0, CL_ENUM);
