// generated from file '/home/brummer/projecte/PowerAmps/PreAmps/12ax7.dsp' by dsp2cc:
...
#define fVslider1 (*fVslider1_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp0 = double(input0[i0]) * fRec15[0] * 0.666;
		fVec0[0] = fTemp0;
		...
		double fTemp3 = (fTemp1 + fTemp2) / (Ranode(TUBE_TABLE_12AX7_68k, fRec12[1]) + 1e+05);
		fVec1[0] = fTemp3;
		fRec16[0] = fConst3 * (2.7e+03 * (fTemp3 + fVec1[1]) - fConst2 * fRec16[1]);
		fRec12[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp2 + fRec16[0] + fTemp1 + -1.581656) + -191.42014814814814;
		fRec11[0] = fConst6 * (fConst5 * fRec11[1] + 0.025 * (fRec12[0] - fRec12[1]));
		...
		double fTemp6 = (fTemp4 + fTemp5) / (Ranode(TUBE_TABLE_12AX7_250k, fRec7[1]) + 1e+05);
		fVec2[0] = fTemp6;
		fRec17[0] = fConst12 * (1.5e+03 * (fTemp6 + fVec2[1]) - fConst11 * fRec17[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp5 + fRec17[0] + fTemp4 + -1.204285) + -169.71433333333334;
		fRec6[0] = fConst6 * (fConst5 * fRec6[1] + 0.025 * (fRec7[0] - fRec7[1]));
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AX7_250k, fRec2[1]) + 1e+05);
		fVec3[0] = fTemp9;
		fRec18[0] = fConst15 * (8.2e+02 * (fTemp9 + fVec3[1]) - fConst14 * fRec18[1]);
		fRec2[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp8 + fRec18[0] + fTemp7 + -0.840703) + -147.47524390243905;
		fRec1[0] = fConst6 * (fConst5 * fRec1[1] + 0.025 * (fRec2[0] - fRec2[1]));
