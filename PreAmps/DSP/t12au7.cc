// generated from file '/home/brummer/projecte/PowerAmps/PreAmps/t12au7.dsp' by dsp2cc:
...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst2 = 1.0 - fConst1;
	double fConst3 = 1.0 / std::tan(270.1769682087222 / fConst0);
	fConst4 = 1.0 - fConst3;
	fConst5 = 1.0 / (fConst3 + 1.0);
	double fConst6 = 3.141592653589793 / fConst0;
	fConst7 = 1.0 - fConst6;
	fConst8 = 1.0 / (fConst6 + 1.0);
	fConst9 = 1.0 / (fConst1 + 1.0);
...
#define fVslider1 (*fVslider1_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp0;
		fRec14[0] = 3.7211391701295655 * (fTemp0 + fVec0[1]) - 0.8605695850647829 * fRec14[1];
		...
		double fTemp3 = (fTemp1 + fTemp2) / (Ranode(TUBE_TABLE_12AU7_68k, fRec12[1]) + 1e+05);
		fVec1[0] = fTemp3;
		fRec16[0] = fConst5 * (2.7e+03 * (fTemp3 + fVec1[1]) - fConst4 * fRec16[1]);
		fRec12[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp2 + fRec16[0] + fTemp1 + -3.718962) + -112.26066666666668;
		fRec11[0] = fConst8 * (fConst7 * fRec11[1] + 0.025 * (fRec12[0] - fRec12[1]));
		fRec10[0] = 0.0 - fConst9 * (fConst2 * fRec10[1] - (fRec11[0] + fRec11[1]));
		...
		double fTemp6 = (fTemp4 + fTemp5) / (Ranode(TUBE_TABLE_12AU7_250k, fRec7[1]) + 1e+05);
		fVec2[0] = fTemp6;
		fRec17[0] = fConst12 * (1.5e+03 * (fTemp6 + fVec2[1]) - fConst11 * fRec17[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp5 + fRec17[0] + fTemp4 + -2.314844) + -95.67706666666666;
		fRec6[0] = fConst8 * (fConst7 * fRec6[1] + 0.025 * (fRec7[0] - fRec7[1]));
		fRec5[0] = fConst9 * (4.0 * (fRec6[0] + fRec6[1]) - fConst2 * fRec5[1]);
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AU7_250k, fRec2[1]) + 1e+05);
		fVec3[0] = fTemp9;
		fRec18[0] = fConst15 * (8.2e+02 * (fTemp9 + fVec3[1]) - fConst14 * fRec18[1]);
		fRec2[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp8 + fRec18[0] + fTemp7 + -1.356567) + -84.565;
		fRec1[0] = fConst8 * (fConst7 * fRec1[1] + 0.025 * (fRec2[0] - fRec2[1]));
		output0[i0] = FAUSTFLOAT(4.0 * fRec1[0] * fRec0[0]);
		fRec0[1] = fRec0[0];
		fRec15[1] = fRec15[0];
		fVec0[1] = fVec0[0];
		fRec14[1] = fRec14[0];
