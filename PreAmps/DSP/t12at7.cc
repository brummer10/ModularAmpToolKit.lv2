// generated from file '/home/brummer/projecte/PowerAmps/PreAmps/t12at7.dsp' by dsp2cc:
...
#define fVslider1 (*fVslider1_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp3 = (fTemp1 + fTemp2) / (Ranode(TUBE_TABLE_12AT7_68k, fRec12[1]) + 1e+05);
		fVec1[0] = fTemp3;
		fRec16[0] = fConst3 * (2.7e+03 * (fTemp3 + fVec1[1]) - fConst2 * fRec16[1]);
		fRec12[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp2 + fRec16[0] + fTemp1 + -2.617753) + -153.04618518518518;
		...
		double fTemp6 = (fTemp4 + fTemp5) / (Ranode(TUBE_TABLE_12AT7_250k, fRec7[1]) + 1e+05);
		fVec2[0] = fTemp6;
		fRec17[0] = fConst12 * (1.5e+03 * (fTemp6 + fVec2[1]) - fConst11 * fRec17[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp5 + fRec17[0] + fTemp4 + -1.887332) + -124.17786666666666;
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AT7_250k, fRec2[1]) + 1e+05);
		fVec3[0] = fTemp9;
		fRec18[0] = fConst15 * (8.2e+02 * (fTemp9 + fVec3[1]) - fConst14 * fRec18[1]);
		fRec2[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp8 + fRec18[0] + fTemp7 + -1.256962) + -96.7119512195122;
